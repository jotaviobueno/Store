...
import { CreateUserInput, IdInput, PaginationOptionsInput, UpdateUserInput } from "src/domain/dtos";
...
export class UserResolver {
  constructor(private readonly userService: UserService, private readonly userRoleDataloader: UserRoleDataloader) {
  }
